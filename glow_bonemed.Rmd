...
mosaicplot(table(glow_bonemed$bonetreat, glow_bonemed$fracture), 
           color = TRUE,
           xlab = "Recieved bone medication treatment at enrollment and at follow up",
           ylab = "Fracture",
           main = "Mosaic Plot of Bone Treatement and Fracture")
mosaicplot(table(glow_bonemed$priorfrac, glow_bonemed$fracture), color = TRUE)
mosaicplot(table(glow_bonemed$bonemed, glow_bonemed$fracture), color = TRUE)
mosaicplot(table(glow_bonemed$bonemed_fu, glow_bonemed$fracture), color = TRUE)
```
...
forestModel = randomForest(fracture ~ priorfrac + age + smoke + bonemed + bonemed_fu, 
